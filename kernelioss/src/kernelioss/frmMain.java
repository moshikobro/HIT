...
public class frmMain {
	...
	private void initialize()  {
		...
		JButton btnNewButton = new JButton("   תשלומים   ");
		btnNewButton.setFont(new Font("Arial", Font.BOLD, 16));
		tb.add(btnNewButton);
		
		JButton btnNewButton_1 = new JButton("   סטודנטים   ");
		btnNewButton_1.setFont(new Font("Arial", Font.BOLD, 16));
		tb.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("   ציונים   ");
		btnNewButton_2.setFont(new Font("Arial", Font.BOLD, 16));
		tb.add(btnNewButton_2);
		
		JButton btnNewButton_3 = new JButton("   מרצים   ");
		btnNewButton_3.setFont(new Font("Arial", Font.BOLD, 16));
		tb.add(btnNewButton_3);
		
		JButton btnNewButton_4 = new JButton("   קורסים   ");
